...
- 언론사명 앞에 🟠와 같은 다른 색상의 이모지를 사용하며 언론사 섹션 사이에는  ━━━━━━━━━━━ 구분선을 사용
...
- 작성자 소개 문구 제외
- 반드시 기사 링크 포함
- 키워드는 텔레그램 해시태그 형식으로 내부에 공백이나 특수문자를 절대로 넣지 말고 3개 이하로 간결하게 작성

- 키워드와 링크는 공백 2칸 들여쓰기
- 동일 주제 뉴스는 하나만 선택
- 중복 기사 제거
- 기사링크는 https://example.com/... 형식으로 ...은 20자 이하로 축약해서 표시
